#!/usr/bin/env sh
# Universal installer for oraclewatch. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/oraclewatch.git"
echo "Installing oraclewatch ..."
...
echo "Done. Run: oraclewatch --help"
