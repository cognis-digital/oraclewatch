"""Native cognis-connect emit for oraclewatch — forward findings to any platform.

Maps oraclewatch's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    oraclewatch ... --format json | oraclewatch-emit --to stix
    oraclewatch-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
